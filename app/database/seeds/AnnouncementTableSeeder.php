...
class AnnouncementTableSeeder extends Seeder {
  ...
  public function run() {
    ...
    Announcement::create([
        ...
        'created_at' => '2014-06-06 11:30:12'
    ]);
    ...
    Announcement::create([
        ...
        'created_at' => '2014-06-07 11:31:12'
    ]);
